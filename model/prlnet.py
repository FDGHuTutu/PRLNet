...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.ghost1 = GhostModule(inplanes, planes, kernel_size=3, stride=stride, padding=1)
...
class PRLNet(nn.Module):
    def __init__(self, base_channel: int = 32, num_joints: int = 17):
        ...
        # Final layer
        self.eca_final_1 = ECA_Layer(base_channel)
        self.eca_final_2 = ECA_Layer(base_channel)
        self.eca_final_3 = ECA_Layer(base_channel)
        self.eca_final_4 = ECA_Layer(base_channel)
    ...
    def forward(self, x):
        ...
        x = x[0]
        x = self.eca_final_1(x)
        x = self.eca_final_2(x)
        x = self.eca_final_3(x)
        x = self.eca_final_4(x)
