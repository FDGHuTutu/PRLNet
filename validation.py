...
def main(args):
    ...
    model.load_state_dict(torch.load(weights_path, map_location='cpu'),False)
    # print(model)
    model.to(device)
...
if __name__ == "__main__":
    ...
    # 训练好的权重文件
    parser.add_argument('--weights-path', default='./prlnet.pth', type=str, help='training weights')
